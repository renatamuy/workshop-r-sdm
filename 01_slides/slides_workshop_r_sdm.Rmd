...
### 6. O que descobriram nessa pandemia?
...
background-image: url(img/sdm_metodos_bioclim01.png), url(img/sdm_metodos_mahalanobis02.png), url(img/sdm_metodos_rf01.png), url(img/sdm_metodos_maxent.png)
background-size: 300px, 250px, 400px, 400px
background-position: 9% 80%, 45% 80%, 90% 80%, 90% 20%
...
<br><br><br><br><br><br>
[Wegmann et al. (2016)](http://book.ecosens.org/),
[Fletcher & Fortin (2018)](https://www.springer.com/gp/book/9783030019884)
...
[Wickham (2016)](https://ggplot2-book.org/),
...
- **Requisitos**: componente abiótico, biótico e movimento
...
- $r_{i,g}(\vec e_g)$: termo de **crescimento intríseco** da população, onde $\vec e_g$ são as condições abióticas da espécie i na célula g
...
# Vamos olhar para os mesmos conceitos de **requerimentos** (abiótico, biótico e movimento), mas agora desenhando e com sapos...
...
- O modelo vai **estimar o nicho ecológico** no Espaço Ambiental (E) e **predizer** a distribuição no Espaço Geográfico (G)
...
# Bem, mas esses modelos estimam o **nicho realizado** sendo denominados **Modelos Correlativos**, pois correlacionam as ocorrências com as condições ambientais

---

class: inverse, center, middle

# Há ainda os **Modelos Mecanísticos** que estimam o **Nicho Fundamental**
...
# Uma vez ajustados nossos modelos, devemos avaliar seu **desempenho** antes de fazer as predições para todo o Espaço Geográfico (G)
...
# Vamos para o R preparar e particionar os nossos dados, e ajustar nossos modelos
...
# Vamos para o R avaliar nossos modelos

---

class: inverse, center, middle

# Uma vez que **avaliamos a calibração dos modelos** (acertam as presenças e pseudo-ausências) podemos fazer a **predição** para áreas desconhecidas
...
## Contabilizar quantas vezes um pixel foi previsto como presença
...
## Calcular a média dos valores de adequabilidade para cada pixel
...
## Calcular a média ponderada dos valores de adeq. para cada pixel
...
## Calcular um valor de incerteza para cada pixel
...
# Vamos para o R predizer e fazer o consenso dos nossos modelos
...
- [Prof. Ubirajara de Oliveira](https://ubiologia.wixsite.com/biogeografia/modelos-de-distribuicao-de-especies)

- [Profa. Luara Tourinho](https://www.youtube.com/playlist?list=PLo25BjoudnByh9PGT8JqqFtwf2M5w8CxU)

## Inglês

- [Prof. Townsend Peterson](https://www.facebook.com/groups/ENM2020/)

- [Profa. Damaris Zurell](https://damariszurell.github.io/SDM-Intro/)

- [Prof. Babak Naimi](https://youtu.be/83dMS3bcjJM)

- [Species Distribution Modeling Remote with  Sensing (NASA)](https://appliedsciences.nasa.gov/join-mission/training/english/arset-species-distribution-modeling-remote-sensing)

- [BCCVL Training](https://app.bccvl.org.au/training)
